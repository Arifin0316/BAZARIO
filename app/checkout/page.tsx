      ...
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-gray-600 dark:text-gray-400">Complete your order</p>
              </div>
            </div>
            <Link 
              href="/cart" 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm dark:shadow-xl p-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm dark:shadow-xl p-6 lg:sticky lg:top-4">
            ...
            <div className="mt-6 bg-green-50 dark:bg-green-900/20 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-sm font-medium text-green-900 dark:text-green-300">Secure Checkout</h3>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div className="space-y-1">
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400">SSL Encrypted Checkout</p>
            </div>
            <div className="space-y-1">
              <div className="text-gray-600 flex justify-center">🚚</div>
            ...
            <div className="space-y-1">
              <div className="text-gray-600 flex justify-center">💯</div>
              <p className="text-sm font-medium text-gray-900 dark:text-white">Satisfaction</p>
              <p className="text-xs text-gray-600 dark:text-gray-400">30-Day Money Back</p>
            </div>
            <div className="space-y-1">
              <div className="text-gray-600 flex justify-center">💬</div>
